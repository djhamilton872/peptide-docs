...
- FDA-approved for diagnosing, treating, or preventing any condition
...
- Starting any new peptide, supplement, or medication
- Modifying dosages or schedules
- Making health decisions based on lab results
...
The dosing calculations and estimates provided by this Service are **convenience features only**.

{: .important }
> **YOU MUST verify all calculations independently before use.**
...
4. **You accept** that we are not liable for health outcomes
...
{: .danger }
> **If you are experiencing a medical emergency, call 911 or your local emergency services immediately. Do not rely on this app for emergency medical guidance.**
