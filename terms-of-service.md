...
**The Service is a tracking tool only. It does not provide medical advice, diagnoses, or treatment recommendations.**
...
THE SERVICE IS NOT INTENDED TO PROVIDE MEDICAL ADVICE. All information, content, and features are provided for informational and personal tracking purposes only.

### 2.2 Consult Healthcare Providers

Before starting, modifying, or discontinuing any peptide, supplement, or medication regimen, you MUST consult with a qualified healthcare provider. Do not rely on this Service as a substitute for professional medical advice.

### 2.3 Dosing Calculations
...
We are not responsible for any health outcomes, adverse reactions, or consequences resulting from:
- Use of information from the Service
- Reliance on dosing calculations or estimates
...
You agree to provide accurate, current, and complete information when using the Service. The quality of calculations and tracking depends entirely on the accuracy of data you enter.

### 3.3 Lawful Use

You agree to use the Service only for lawful purposes and in accordance with all applicable laws and regulations in your jurisdiction.
...
The Service offers multiple subscription tiers (Free, Standard, Premium) with varying features and limits.

### 4.2 Billing

Paid subscriptions are billed monthly or annually as selected. You authorize us to charge your payment method for all fees incurred.
...
### 5.1 No Guarantee of Uptime

While we strive to maintain high availability, we do not guarantee uninterrupted access to the Service. The Service is provided "as is" and "as available."

### 5.2 Scheduled Maintenance

Routine maintenance is typically performed during low-usage periods:
- **Primary Window:** Sundays, 10:00 PM - 11:00 PM Central Time
- **Secondary Window:** As needed with advance notice when possible

### 5.3 Emergency Maintenance

We reserve the right to perform emergency maintenance at any time without prior notice to address security issues, critical bugs, or infrastructure problems.

### 5.4 Service Modifications

We may modify, suspend, or discontinue any part of the Service at any time. We will provide reasonable notice for significant changes.
...
You retain ownership of all data you enter into the Service. We do not sell your personal or health data to third parties.

### 6.2 Data Storage

Your data is stored on secure servers. We implement reasonable security measures but cannot guarantee absolute security.
...
Our collection and use of personal information is governed by our [Privacy Policy](/privacy-policy).
...
- Health outcomes or medical decisions
